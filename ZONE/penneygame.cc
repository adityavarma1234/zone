  ...
  TEST
    {
      ...
      scanf("%s",a);
      cout << t<<" ";
      cout << nooftimes("TTT",a)<<" ";
      cout << nooftimes("TTH",a)<<" ";
      cout << nooftimes("THT",a)<<" ";
      cout << nooftimes("THH",a)<<" ";
      cout << nooftimes("HTT",a)<<" ";
      cout << nooftimes("HTH",a)<<" ";
      cout << nooftimes("HHT",a)<<" ";
      cout << nooftimes("HHH",a)<<" ";
      cout << endl;
    }
  return 0;
}
